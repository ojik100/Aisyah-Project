                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="container">
                            ...
                            <form action="<?= base_url() ?>Indikator/save" method="POST">
                                <div>
								...
								<div>
                                    ...
                                    <input type="number" class="form-control" placeholder="Enter Tingi badan ct 10 cm" name="tinggi_badan"
                                        id="" required>
                                </div>
								<div>
                                ...
                                <div style="text-align:right;">
                                    <button class="btn btn-success btn-sm">Tambah Indikator</button>
